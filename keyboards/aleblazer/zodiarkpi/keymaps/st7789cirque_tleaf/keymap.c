...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
      ...
      KC_CAPS_LOCK, KC_A,  KC_S,    KC_D,    KC_F,    KC_G,  KC_LBRC , KC_MUTE,                      RGB_TOG, KC_RBRC,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,  MO(1), KC_MINS,                           KC_EQL, MO(2), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT ,
      KC_LCTL, KC_LALT, KC_LGUI, RGB_TOG, KC_HOME,  KC_LSFT,   RGB_TOG,                        RGB_TOG,  KC_SPC,  KC_END,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
